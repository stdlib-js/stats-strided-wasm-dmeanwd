...
tape( 'a module instance has a `main` method which calculates the arithmetic mean of a strided array', function test( t ) {
	var mem;
	var mod;
	var xp;
	var y;
...
tape( 'if provided an `N` parameter less than or equal to `0`, a module instance has a `main` method which returns `NaN`', function test( t ) {
	var mem;
	var mod;
	var xp;
	var y;
...
tape( 'if provided a `stride` parameter equal to `0`, a module instance has a `main` method returns the first element', function test( t ) {
	var mem;
	var mod;
	var xp;
	var y;
...
tape( 'a module instance has an `main` method which supports an `offset` parameter', function test( t ) {
	var mem;
	var mod;
	var xp;
	var y;
