...
/**
* Interface describing a `dmeanwd` WebAssembly module.
*/
...
interface Routine extends ModuleWrapper {
	...
	*
	* var out = dmeanwd.ndarray( 4, x, 2, 1 );
	* // returns 1.25
	*/
