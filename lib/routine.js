...
*
* // Perform operation:
* var sum = dmeanwd.ndarray( 4, x, 2, 1 );
* // returns 1.25
*/
function Routine() {
...
* // returns ~0.3333
*/
setReadOnly( Routine.prototype, 'main', function dmeanwd( N, x, strideX ) {
...
* // returns 1.25
*/
setReadOnly( Routine.prototype, 'ndarray', function dmeanwd( N, x, strideX, offsetX ) {
	var ptrs;
	var p0;
