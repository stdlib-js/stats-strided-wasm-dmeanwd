...
* var dmeanwd = new Module( mem );
* // returns <Module>
*
* // Initialize the routine:
* dmeanwd.initializeSync();
*
...
* dmeanwd.write( xptr, oneTo( N, dtype ) );
*
* // Perform computation:
* var v = dmeanwd.main( N, xptr, 1 );
* // returns 2.0
*/
...
* // returns 2.0
*/
setReadOnly( Module.prototype, 'main', function dmeanwd( N, xptr, strideX ) {
	return this._instance.exports.stdlib_strided_dmeanwd( N, xptr, strideX );
});
...
*
* // Perform computation:
* var sum = dmeanwd.ndarray( N, xptr, 1, 0 );
* // returns 2.0
*/
setReadOnly( Module.prototype, 'ndarray', function dmeanwd( N, xptr, strideX, offsetX ) {
	return this._instance.exports.stdlib_strided_dmeanwd_ndarray( N, xptr, strideX, offsetX ); // eslint-disable-line max-len
});
